define(['jquery.ui'], function(ui) {
	...
	modal.navs = {
			...
			personlist:{
				name:'人物列表',
				icon:'iconfont2 icon-duoshanghufenxiao',
				params:{
					styledata:'0',
					repeat:'repeat',
					positionx:'left',
	...
	modal.initNavs = function() {
		...
		var navgroup = {
			...
			0: ['listmenu','dp', 'title2', 'bigimg', 'classfit', 'personlist', 'logo', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture','msmk', 'banner', 'service','copyright','picturew','mlist','multiple', 'pt', 'notice','anniu','tcgg','ssk','yhq','xnlf', 'goods', 'tabbar','dnfw', 'kpgg','cases', 'joblist','xfk','contact', 'listdesc','dt','wyrq', 'feedback', 'footmenu', 'video','yuyin', 'ad','ddlb']
